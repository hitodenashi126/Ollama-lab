      ...
      <div className="relative flex flex-col gap-2 p-2 bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-2xl border border-black/10 dark:border-white/10 shadow-2xl shadow-black/40 ring-1 ring-white/5 transition-colors">
        ...
        <div className="flex items-end gap-2 pr-2">
          <textarea
            ...
            className="flex-1 w-full bg-transparent px-3 py-2.5 text-sm text-slate-800 dark:text-white focus:outline-none resize-none placeholder:text-neutral-500 min-h-[44px] max-h-[200px] transition-colors"
            disabled={disabled}
          />
          <button
            ...
            className={cn(
              ...
              input.trim() && !disabled 
                ? "bg-blue-600 text-white hover:bg-blue-500 translate-y-[-1px] shadow-lg shadow-blue-600/30 active:translate-y-0" 
